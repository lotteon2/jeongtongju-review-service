...
public interface ReviewRepository extends JpaRepository<Review, Long> {
  ...
  @Query(
      "select new com.jeontongju.review.dto.response.GetMyReviewDto(r.reviewId, r.productId, r.productThumbnailImage, r.contents, r.imageUrl) from Review r where r.isDeleted = false and r.consumerId = :memberId")
